...
from jaxmaze.human_dyna.multitask_env import sample_spawn_locs
from jaxmaze.human_dyna.multitask_env import EnvParams

from jaxmaze.human_dyna.multitask_env import TimeStep
from jaxmaze.human_dyna.multitask_env import StepType
...
class HouseMaze(multitask_env.HouseMaze):
  def reset(self, rng: jax.Array, params: EnvParams) -> TimeStep:
    ...
    ##################
    reset_params_idx = 0
    reset_params = jax.tree_util.tree_map(
